...
<div class="mb-6 md:mb-8 pt-6 md:pt-0">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl md:text-3xl lg:text-4xl font-bold text-charcoal mb-1 md:mb-2">Kelola Slideshow</h1>
            <p class="text-[11px] md:text-sm text-text/60">Kelola gambar slideshow halaman utama</p>
        </div>
        <a href="{{ route('slideshow.create') }}" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-sunset hover:shadow-lg text-white font-bold rounded-xl transition-all duration-300 uppercase tracking-widest text-[10px]">
...
<div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 mb-8">
    <!-- Table -->

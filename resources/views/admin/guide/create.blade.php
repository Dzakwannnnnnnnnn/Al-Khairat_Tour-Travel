...
<div class="mb-8">
    <div class="flex items-center gap-4 mb-4">
        ...
        <div>
            <h1 class="text-3xl md:text-4xl font-bold text-charcoal">Tambah Panduan Baru</h1>
            <p class="text-text/60 mt-1">Buat panduan baru untuk umrah atau haji</p>
        </div>
    </div>
</div>
            ...
            <form method="POST" action="{{ route('guides.store') }}">
                ...
                <div class="p-8 border-b border-slate-200">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" placeholder="dokumen, checklist, tata-cara, faq, doa, tips" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange focus:border-transparent @error('slug') border-red-500 @enderror" value="{{ old('slug') }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" placeholder="Contoh: Dokumen Perjalanan Umrah" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange focus:border-transparent @error('title') border-red-500 @enderror" value="{{ old('title') }}">
                            @error('title')
                                <div class="mt-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="badge" placeholder="DOKUMEN, CHECKLIST, TATA CARA, FAQ, DO'A, TIPS" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange focus:border-transparent @error('badge') border-red-500 @enderror" value="{{ old('badge') }}">
                            @error('badge')
                                <div class="mt-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="icon" placeholder="✈️, 📋, 🕌, ❓, 🤲, 💡" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange focus:border-transparent @error('icon') border-red-500 @enderror" value="{{ old('icon') }}">
                            @error('icon')
                                <div class="mt-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3" placeholder="Deskripsi singkat tentang panduan ini (maks 500 karakter)" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange focus:border-transparent resize-none @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="mt-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                </div>
                        ...
                        <div>
                            ...
                            <textarea name="overview" rows="5" placeholder="Penjelasan lengkap tentang panduan ini" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange focus:border-transparent resize-none @error('overview') border-red-500 @enderror">{{ old('overview') }}</textarea>
                            @error('overview')
                                <div class="mt-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                </div>
                ...
                <div class="p-8 border-b border-slate-200">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="key_points" rows="4" placeholder='[{"title": "Poin 1", "description": "Deskripsi poin 1"}, {"title": "Poin 2", "description": "Deskripsi poin 2"}]' class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange focus:border-transparent resize-none font-mono text-xs @error('key_points') border-red-500 @enderror">{{ old('key_points') ? json_encode(json_decode(old('key_points')), JSON_PRETTY_PRINT) : '' }}</textarea>
                            @error('key_points')
                                <div class="mt-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                </div>
                        ...
                        <div>
                            ...
                            <textarea name="sections" rows="6" placeholder='[{"heading": "Judul Seksi", "content": "Deskripsi", "items": ["Item 1", "Item 2"]}]' class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange focus:border-transparent resize-none font-mono text-xs @error('sections') border-red-500 @enderror">{{ old('sections') ? json_encode(json_decode(old('sections')), JSON_PRETTY_PRINT) : '' }}</textarea>
                            @error('sections')
                                <div class="mt-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                </div>
                        ...
                        <div>
                            ...
                            <textarea name="tips" rows="4" placeholder='["Tip 1", "Tip 2", "Tip 3"]' class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange focus:border-transparent resize-none font-mono text-xs @error('tips') border-red-500 @enderror">{{ old('tips') ? json_encode(json_decode(old('tips')), JSON_PRETTY_PRINT) : '' }}</textarea>
                            @error('tips')
                                <div class="mt-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                </div>
                ...
                <div class="p-8">
                    <div class="flex items-center gap-3 p-4 bg-slate-50 rounded-lg border border-slate-200">
                        <input type="checkbox" name="is_active" id="is_active" value="1" checked class="w-5 h-5 text-orange rounded focus:ring-2 focus:ring-orange">

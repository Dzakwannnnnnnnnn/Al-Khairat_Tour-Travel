        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden transition-all hover:shadow-md">
            ...
            <div class="p-5 md:p-6 bg-slate-50 border-b border-slate-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div class="flex items-center gap-3 w-full md:w-auto">
                    ...
                    @endif
                    @if($groupCode)
                        <a href="{{ route('booking.invoice', $groupCode) }}" class="group flex-1 md:flex-none inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-white text-[#E07856] border border-[#E07856]/20 rounded-xl text-xs font-bold hover:bg-[#E07856] hover:!text-white transition-all shadow-sm">

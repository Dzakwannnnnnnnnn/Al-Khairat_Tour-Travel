...
<header class="sticky top-0 z-50 transition-all duration-500 w-full px-2 md:px-4 py-2 md:py-4">
    <div class="max-w-[1600px] mx-auto flex justify-between items-center bg-white rounded-xl md:rounded-2xl px-4 md:px-6 py-2 md:py-3 border-slate-200 shadow-xl">
        ...
        <div class="flex items-center gap-3 sm:gap-6">
            ...
            <!-- Dark Mode Toggle -->
            <button onclick="toggleDashboardTheme()" id="dashboardThemeToggle" class="p-2 rounded-xl hover:bg-slate-100 transition-all text-slate-500 hover:text-orange" title="Toggle Dark/Light Mode">
                <svg id="themeIconSun" class="w-5 h-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                <svg id="themeIconMoon" class="w-5 h-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path></svg>
            </button>

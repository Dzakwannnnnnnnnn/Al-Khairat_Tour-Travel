        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-stretch px-2 md:px-0">
                ...
                <div class="space-y-3 flex flex-col justify-between">
                    ...
                    <a href="https://wa.me/62" target="_blank" class="btn-primary w-full text-center py-3 md:py-4 text-sm md:text-lg font-bold flex items-center justify-center space-x-2 md:space-x-3 group scroll-animate" data-animation="fade-up">
                        <svg class="w-5 h-5 md:w-6 md:h-6 animate-float" fill="currentColor" viewBox="0 0 24 24">

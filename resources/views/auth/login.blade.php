            ...
            <div class="auth-form-card">
                ...
                <form method="POST" action="{{ route('login') }}" style="display:flex;flex-direction:column;gap:1.5rem;">
                    ...
                    <div style="position:relative; margin: 1.5rem 0; text-align:center;">
                        ...
                        <span style="position:relative; background:#FBF8F3; padding:0 1rem; color:#8B6F47; font-size:0.75rem; font-weight:600; text-transform:uppercase; letter-spacing:0.05em;">Atau masuk dengan</span>
                    </div>

                    <button type="button" class="google-btn" onclick="alert('Fitur masuk dengan Google sedang dalam tahap pengembangan. Silakan gunakan email dan kata sandi untuk saat ini.')" style="width:100%; display:flex; align-items:center; justify-content:center; gap:0.75rem; padding:0.9rem; background:white; border:1px solid rgba(44,36,22,0.12); border-radius:0.75rem; color:#2C2416; font-weight:600; font-size:0.875rem; cursor:pointer; transition:all 0.2s;">

        ...
        <div class="auth-right">
            ...
            <div class="auth-form-card">
                ...
                <form method="POST" action="{{ route('register') }}" style="display:flex;flex-direction:column;gap:1.5rem;">
                    ...
                    <a href="{{ route('auth.google') }}" class="google-btn" style="width:100%; display:flex; align-items:center; justify-content:center; gap:0.75rem; padding:0.9rem; background:white; border:1px solid rgba(44,36,22,0.12); border-radius:0.75rem; color:#2C2416; font-weight:600; font-size:0.875rem; cursor:pointer; transition:all 0.2s; text-decoration:none;">

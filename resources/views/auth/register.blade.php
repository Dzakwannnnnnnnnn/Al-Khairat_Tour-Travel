        ...
        <div class="auth-right">
            ...
            <div class="auth-form-card">
                ...
                <div style="display:flex; align-items:center; gap:1rem; margin:1.5rem 0;">
                    <div style="flex:1; height:1px; background:linear-gradient(to right, transparent, #D4C5B0, transparent);"></div>
                    <span style="font-size:0.75rem; color:#8B6F47; font-weight:600; text-transform:uppercase; letter-spacing:0.1em;">atau</span>
                    <div style="flex:1; height:1px; background:linear-gradient(to right, transparent, #D4C5B0, transparent);"></div>
                </div>

                <!-- Google Register Button -->
                <a href="{{ route('auth.google') }}" style="display:flex; align-items:center; justify-content:center; gap:0.75rem; width:100%; padding:0.875rem 1.5rem; background:#fff; border:2px solid #E5DDD3; border-radius:1rem; font-size:0.9375rem; font-weight:700; color:#2C2416; text-decoration:none; transition:all 0.25s; cursor:pointer; box-shadow:0 2px 8px rgba(44,36,22,0.06);"
                   onmouseover="this.style.borderColor='#E07856'; this.style.boxShadow='0 4px 16px rgba(224,120,86,0.15)'; this.style.transform='translateY(-1px)'"
                   onmouseout="this.style.borderColor='#E5DDD3'; this.style.boxShadow='0 2px 8px rgba(44,36,22,0.06)'; this.style.transform='translateY(0)'">

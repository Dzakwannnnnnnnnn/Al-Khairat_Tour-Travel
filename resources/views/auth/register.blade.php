        ...
        <div class="auth-right">
            ...
            <div class="auth-form-card">
                ...
                <form method="POST" action="{{ route('register') }}" style="display:flex;flex-direction:column;gap:1.5rem;">
                    ...
                    <!-- Email -->
                    <div>
                        <label for="email" class="auth-label">Email Google (Gmail)</label>
                        <div class="auth-input-group">
                    ...
                    <div style="position:relative; margin: 1.5rem 0; text-align:center;">
                        <div style="position:absolute; top:50%; left:0; right:0; border-top:1px solid rgba(44,36,22,0.1);"></div>
                        <span style="position:relative; background:#FBF8F3; padding:0 1rem; color:#8B6F47; font-size:0.75rem; font-weight:600; text-transform:uppercase; letter-spacing:0.05em;">Atau daftar dengan</span>
                    </div>

                    <button type="button" class="google-btn" onclick="alert('Fitur daftar dengan Google sedang dalam tahap pengembangan. Silakan gunakan formulir pendaftaran di atas.')" style="width:100%; display:flex; align-items:center; justify-content:center; gap:0.75rem; padding:0.9rem; background:white; border:1px solid rgba(44,36,22,0.12); border-radius:0.75rem; color:#2C2416; font-weight:600; font-size:0.875rem; cursor:pointer; transition:all 0.2s;">
